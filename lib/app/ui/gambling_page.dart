...
class _GamblingPageState extends State<GamblingPage> {
  ...
  List<Widget> buttonList() {
    ...
    var quarter =
        _betting.getBettingAmount() + (_betting.getBettingAmount() ~/ 4);
    ...
    if (moreBetting && bettingPrice <= money && _betting.raiseCheck()) {
      buttonList.add(
          bettingButtonUtil('콜', moreBetting ? Colors.blue : Colors.grey, () {
        if (!moreBetting) {
          return;
        }
      ...
      buttonList.add(
          bettingButtonUtil('체크', !moreBetting ? Colors.blue : Colors.grey, () {
        if (moreBetting) {
          return;
        }
    ...
    buttonList.add(bettingButtonUtil(
        '하프', (half <= money) ? Colors.blue : Colors.grey, () {
      if (!(half <= money)) {
        return;
      }
    ...
    buttonList.add(bettingButtonUtil(
        '쿼터', (quarter <= money) ? Colors.blue : Colors.grey, () {
      if (!(quarter <= money)) {
        return;
      }
    ...
    buttonList.add(bettingButtonUtil(
        '따당', (double <= money) ? Colors.blue : Colors.grey, () {
      if (!(double <= money)) {
        return;
      }
    ...
    buttonList.add(bettingButtonUtil('삥',
        (bettingPrice < money) && !moreBetting ? Colors.blue : Colors.grey,
        () {
